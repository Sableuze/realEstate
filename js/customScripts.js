...
function outputGoods(goods) {
    ...
    <div class="single-house unhide">
        <div class="front">
            <img src="${n.image}" width="334" height="265" alt="home image">
